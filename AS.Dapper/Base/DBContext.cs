...
namespace AS.OCR.Dapper.Base
{
    public static class DBContext
    {
        ...
        /// <returns></returns>
        public static long Add<T>(T model,IDbTransaction dbTransaction=null) where T : class
        {
            return Db.Insert(model, dbTransaction);
        }
        /// <summary>
        /// 删
        /// </summary>
        ...
        /// <param name="model"></param>
        /// <returns></returns>
        public static bool Update<T>(T model, IDbTransaction dbTransaction = null) where T : class
        {
            return Db.Update(model, dbTransaction);
        }
